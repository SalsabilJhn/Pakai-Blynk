...
4. ESP8266 1 buah. 
   Dengan format kode:  
   DHT 11 --›[ESP8266 pin input].
   [ESP8266 pin SCL SDA] ---› LCD I2C. 
   [ESP8266 pin output]. ---› Buzzer. 

  -ESP membaca sensor DHT11. 
  -Output DHT11 ditampilkan melalui display LCD I2C. 
  -Output Buzzer akan menyala jika suhu melebihi batas set point. 
